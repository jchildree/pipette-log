...
When exploring the codebase, use vocabulary from `docs/agents/domain.md` so test names match the project's language, and respect ADRs in the area you're touching.
